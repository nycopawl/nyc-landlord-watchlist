  ...
  .directive('mapDiv', [function() {
    ...
    return {
      ...
      link: function(scope, elm, attrs) {
        ...
        L.mapbox.tileLayer('http://maps2.albatrossdigital.com:8888/v2/watchlist3_3b1205.json').addTo(map);

        // Load interactivity data into the map with a gridLayer
        var gridLayer = L.mapbox.gridLayer('http://maps2.albatrossdigital.com:8888/v2/watchlist3_3b1205.json');
        gridLayer.addTo(map);
