  ...
  .directive('mapDiv', [function() {
    ...
    return {
      ...
      link: function(scope, elm, attrs) {
        ...
        L.mapbox.tileLayer('http://54.214.3.79:8888/v2/watchlist3_5b960e.json').addTo(map);
        ...
        var gridLayer = L.mapbox.gridLayer('http://54.214.3.79:8888/v2/watchlist3_5b960e.json');
        gridLayer.addTo(map);
