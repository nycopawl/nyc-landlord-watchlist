  ...
  .directive('mapDiv', [function() {
    ...
    return {
      ...
      link: function(scope, elm, attrs) {
        ...
        L.mapbox.tileLayer('http://maps.albatrossdigital.com:8888/v2/watchlist3_4a27b3.json').addTo(map);
        ...
        var gridLayer = L.mapbox.gridLayer('http://maps.albatrossdigital.com:8888/v2/watchlist3_4a27b3.json');
        gridLayer.addTo(map);
