  ...
  .directive('mapDiv', [function() {
    ...
    return {
      ...
      link: function(scope, elm, attrs) {
        ...
        L.mapbox.tileLayer('http://maps.albatrossdigital.com:8888/v2/watchlist3_e2cdef.json').addTo(map);
        ...
        var gridLayer = L.mapbox.gridLayer('http://maps.albatrossdigital.com:8888/v2/watchlist3_e2cdef.json');
        gridLayer.addTo(map);
