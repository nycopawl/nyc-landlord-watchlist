  ...
  .directive('mapDiv', [function() {
    ...
    return {
      ...
      link: function(scope, elm, attrs) {
        ...
        L.mapbox.tileLayer('http://maps.albatrossdigital.com:8888/v2/watchlist3_94e371.mbtiles').addTo(map);
        ...
        var gridLayer = L.mapbox.gridLayer('http://maps.albatrossdigital.com:8888/v2/watchlist3_94e371.mbtiles');
        gridLayer.addTo(map);
